-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PROCESSING', 'PAID', 'FAILED', 'CANCELLED');
...
-- CreateIndex
CREATE UNIQUE INDEX "WebhookLog_billingId_key" ON "WebhookLog"("billingId");

-- CreateIndex
CREATE UNIQUE INDEX "WebhookLog_paymentId_key" ON "WebhookLog"("paymentId");

-- CreateIndex
CREATE INDEX "WebhookLog_billingId_idx" ON "WebhookLog"("billingId");
